...
function avcp_v_dataset_load()
{
	...
	echo'<div class="updated" id="wpgov-message"><p>Tramite questa pagina puoi verificare se i dataset xml generati presentano problemi di validazione secondo le specifiche di avcp.<br/>
	Ricorda che questo test non garantisce, e anzi <b>ignora</b>, la completezza o veridicita\' delle informazioni inserite, o di dati omessi.</p></div>';
